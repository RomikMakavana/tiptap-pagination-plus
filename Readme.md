...
const editor = new Editor({
  extensions: [
    ...
    PaginationPlus.configure({
      ...
      footerRight: "{page}",  // Custom HTML content to display in the footer right side
      footerLeft: "",         // Custom HTML content to display in the footer left side
      headerRight: "",        // Custom HTML content to display in the header right side
      headerLeft: "",         // Custom HTML content to display in the header left side
